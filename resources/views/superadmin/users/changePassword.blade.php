                        ...
                        <div class="card">
                            <div class="card-body p-0 auth-header-box">
                                <div class="text-center p-3">
                                    ...
                                    <p class="text-muted  mb-0">Please change your password to continue</p>
                                </div>
                            </div>
                            <div class="card-body">
                                @if($errors->any())
                                ...
                                <form class="form-horizontal auth-form my-4" method="POST" action="{{route('doChangePassword',Auth::user()->id)}}">
                                    @csrf
                                    <!--end form-group-->
                                    ...
                                    <div class="form-group mb-0 row">
                                        <div class="col-12 mt-2">
                                            <button class="btn btn-primary btn-block waves-effect waves-light" type="submit">Change Password <i class="fas fa-sign-in-alt ml-1"></i></button>
                                        </div>
                                        <!--end col-->
                                    </div>
                                    <!--end form-group-->
