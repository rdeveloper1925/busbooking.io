@extends('layouts.app')
@section('title',"Bus Booking - Teller Report")
@section('page-title',"Teller Report")
@section('extra-css')
<!-- DataTables -->
...
<ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active">Teller Report</li>
</ol>
@endsection
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <h4 class="mt-0 header-title">Teller Report Summary</h4>
                {{-- <div class="row">
